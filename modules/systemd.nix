...
}:
{
  fileSystems = {
    ...
    "/mnt/nvme2024" = {
      # label = "Manjaro Root";
      device = "/dev/disk/by-uuid/UUID=0b46aa16-1916-45d3-8577-fdc0ad917bef";
      fsType = "ext4";
      options = [
        "defaults"
        "noatime"
    ...
    "/mnt/nvme2024/boot" = {
      # label = "Manjaro Boot";
      device = "/dev/disk/by-uuid/UUID=e8cc7c02-9e62-430c-a680-5773effc1e7a";
      fsType = "ext4";
      options = [
        "defaults"
        "noatime"
    ...
    "/mnt/nvme2024/wind" = {
      # label = "Wind";
      device = "/dev/disk/by-uuid/UUID=70d74d2e-077f-4f94-8dff-1c4e127cc49b";
      fsType = "ext4";
      options = [
        "defaults"
        "noatime"
